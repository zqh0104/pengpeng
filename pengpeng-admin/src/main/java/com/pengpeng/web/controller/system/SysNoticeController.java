...
public class SysNoticeController extends BaseController
{
     ...
     */
   /* @RequiresPermissions("system:notice:list")
    @PostMapping("/villageThingsList")
    @ResponseBody
    public TableDataInfo villageThingsList(SysNotice notice)
    {
        startPage();
        //非管理员只查看自己的通知
    ...
    @ResponseBody
    public TableDataInfo announcementList(SysNotice notice)
    {
        startPage();
        //非管理员只查看自己的通知
        if(!ShiroUtils.getSysUser().isAdmin()){
    ...
    @ResponseBody
    public AjaxResult selectNoticeById(Long noticeId)
    {
     ...
     * 审核公告
     */
    @RequiresPermissions("system:notice:approve")
