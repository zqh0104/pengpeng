package com.pengpeng.v4.controller.rechargespec;
 ...
 */
@Controller
@RequestMapping("/api/recharge/spec")
public class PpRechargeSpecController extends BaseController
{
    ...
    public TableDataInfo list(PpRechargeSpec ppRechargeSpec)
    {
        ...
        for (PpRechargeSpec rechargeSpec : list) {
            rechargeSpec.setProductid(rechargeSpec.getId().toString());
        }
