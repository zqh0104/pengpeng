package com.pengpeng.v4.controller.invite;
...
public class PpInviteController extends BaseController
{
    private String prefix = "system/invite";
    ...
    {
        return toAjax(ppInviteService.insertPpInvite(ppInvite));
    }
    ...
    {
        return toAjax(ppInviteService.updatePpInvite(ppInvite));
    }
    ...
    {
        return toAjax(ppInviteService.deletePpInviteByIds(ids));
    }
}
