package com.pengpeng.v4.controller.push;
...
public class PpPushController extends BaseController
{
     ...
     * @return
     */
    @PostMapping( "/addRRegisterId")
    @ResponseBody
    public AjaxResult addRRegisterId( String registerId){

        return ppPushService.addRRegisterId(registerId);
    }
}
